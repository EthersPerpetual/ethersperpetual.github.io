...
if (invitation_code == null || invitation_code == undefined || invitation_code == "") {
    invitation_code = '';
    $(".href_a").attr("href", "https://ethersperpetual.github.io/index-en.html");
} else {
    $(".href_a").attr("href", "https://ethersperpetual.github.io/index-en.html?invite_code=" + invitation_code);
}
        ...
        if (err == null) {
            postFun(url, {
                ...
                if (req.basic.status == "1") {
                    layer_msg("Participation in success");
